            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Vipin Gautam`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Engineer", "Web Developer", "Freelancer" z ]'><span className="wrap">{text}</span></span></h1>
                  <p><b>Computer Science </b> graduate from <b>Bhopal </b>. A Technology-driven engineer focused on scalable systems, efficient architectures, and user-centric solutions. I turn complex problems into clean, high-impact software with curiosity, precision, and disciplined execution.</p>
